# File: ui/handlers/specific_controls_handler.py (FIXED TO RECEIVE LOCALE_MANAGER)
...
class SpecificControlsHandler:
    ...
    def save_timings(self, green_time_str: str, yellow_time_str: str) -> Dict[str, Any]:
        ...
        if is_valid:
            ...
            # The success message should now be generated by the caller (SpecificControlsWidget)
            return {"success": True, "message": "Tempos salvos!"}
        else:
            return {"success": False, "errors": errors}

    # --- CHANGE 3: New function to handle confirmation dialog ---
