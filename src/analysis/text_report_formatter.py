...
# File: src/analysis/text_report_formatter.py
...
class TextReportFormatter:
    ...
    def format_txt_report(
        ...
        report = [
            ...
            "----------------------------------------------------------------------",
            f"* {lm.get_string('report_generator.general_data.scenario')}:         {scenario_name}",
            ...
            "----------------------------------------------------------------------",
            f"* {lm.get_string('report_generator.summary.junctions_analyzed')}: {len(results)}",
